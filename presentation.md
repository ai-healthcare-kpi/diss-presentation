...
.larger-x[ <p class="shadow" style="line-height: 200%;"> 
  ...
  4. Об’єкт і предмет дослідження <br>
  5. Зв'язок з науковими програмами <br>
  6. Переваги та недолiки iснуючих методiв <br>
  7. Наукова новизна результатiв <br>
  8. Аналіз і обговорення отриманих результатів <br>
  9. Висновки <br>    
</p>]
...
.success[Метою даної дисертацiйної роботи є розробка методу глибинного навчання для iдентифiкацiї, класифiкацiї та семантичної сегментацiї об’єктiв з рiвнем продуктивностi (влучнiсть, чутливість, швидкiсть передбачення), що є вищим або спiвставним iз продуктивнiстю фахiвцiв-експертiв у галузi дiагностики легеневих захворювань.]
...
1. Проаналiзувати переваги та недолiки iснуючих методiв машинного навчання, якi застосовуються до задач комп’ютерного зору, запропонувати шляхи вдосконалення;
...
1. .inactive-b[Проаналiзувати переваги та недолiки iснуючих методiв машинного навчання, якi застосовуються до задач комп’ютерного зору, запропонувати шляхи вдосконалення;]
2. Адаптувати та вдосконалити методи глибинного навчання для ефективної дiагностики легеневих захворювань з 2D рентгенограм;
...
1. .inactive-b[Проаналiзувати переваги та недолiки iснуючих методiв машинного навчання, якi застосовуються до задач комп’ютерного зору, запропонувати шляхи вдосконалення;]
2. .inactive-b[Адаптувати та вдосконалити методи глибинного навчання для ефективної дiагностики легеневих захворювань з 2D рентгенограм;]
3. Розробити технологiю попередньої обробки графiчних даних за допомогою сегментацiї дiлянок, якi мiстять цiльовi об’єкти, на основi глибинних нейронних мереж типу кодер-декодер.
...
.title.larger-x[Математичнi методи глибинного навчання для дiагностики легеневих захворювань з 2D рентгенограм.]
...
.title.larger-x[Методи пiдвищення ефективностi нейронних мереж, що базуються на пiдходах орiєнтованих на данi: вилучення тiней кiсток, маски сегментацiї та зменшення розмiрностi даних.]
...
.larger-xx[Наукова новизна результатiв]
...
<div style="position: absolute; right: 2em; top: 20%; transform: translateY(-50%); width: 26%; background: rgba(255,255,255,0.9); border: 1px solid #b0bec5; border-radius: 6px; padding: 0.8em; font-size: 0.7em; color: #555;  line-height: 1.5;">
  Метод пiдвищення ефективностi класифiкацiї у федеративному навчаннi за допомогою ансамблю опорних моделей
</div>
...
.center.caption-fig[Метод пiдвищення ефективностi класифiкацiї у федеративному навчаннi за допомогою ансамблю опорних моделей LCNet050]
...
<div style="position: relative; width: 90%;">
  ...
  <div style="margin-top: 0.1em; font-size: 0.8em; color: #555; font-style: italic;">
    <b>Рис. X.</b> Метод підвищення ефективності класифікації у федеративному навчанні за допомогою ансамблю опорних моделей LCNet050
  </div>
</div>
...
.smaller-xm[
1. Розроблено та адаптовано методи глибинного навчання для задач iдентифiкацiї, класифiкацiї та семантичної сегментацiї об’єктiв на 2D рентгенограмах. Використання сегментацiї анатомiчних структур та вилучення тiней кiсток забезпечило покращення результатiв дiагностики патологiчних станiв легень.

1. Вперше запропоновано технологiю попередньої обробки 2D рентгенограм на основi глибоких нейронних мереж типу кодер-декодер для сегментацiї дiлянок, що мiстять цiльовi об’єкти. Це дозволило пiдвищити ефективнiсть подальшого навчання моделей, зменшити вплив артефактiв та покращити точнiсть класифiкацiї.

1. Розроблено метод зменшення розмiрностi даних на основi t-SNE, що дозволяє виключати викиди серед розподiлу сегментованих масок та пiдвищувати ефективнiсть моделей глибинного навчання у задачi класифiкацiї патологiй легень на основi 2D рентгенограм.

1. Запропоновано пiдхiд для покращення ефективностi класифiкацiї у рамках федеративного навчання на основi ансамблю опорних моделей.
Використання ансамблю моделей з низькою обчислювальною складнiстю дозволило покращити результати узагальнення моделi. Оптимiзацiя таких гiперпараметрiв як кiлькiсть моделей в ансамблi, кiлькiсть локальних епох та розмiр пакету даних додатково дозволяє пiдвищити
ефективнiсть запропонованого пiдходу.

1. Проведено експериментальну оцiнку ефективностi розроблених методiв, яка показала, що поєднання сегментацiї, вилучення тiней кiсток, зменшення розмiрностi даних, аугментацiя даних та використання ансамблю опорних моделей у рамках федеративного навчання дозволяє покращити узагальнювальну здатнiсть та надiйностi систем для автоматизованого аналiзу вiзуальних даних, зокрема для комп’ютерної дiагностики захворювань з продуктивнiстю, яка спiвставна з рiвнем лiкарiв-експертiв.

]


???
У дисертацiйному дослiдженнi розв’язане актуальне наукове завдання, яке спрямоване на пiдвищення ефективностi та надiйностi автоматизованих
методiв аналiзу вiзуальних даних, зокрема таких, що представленi у виглядi рентгенограм, шляхом створення та оптимiзацiї методiв i моделей глибинного машинного навчання для iдентифiкацiї, класифiкацiї та семантичної сегментацiї об’єктiв. У результатi було отримано такi науковi i практичнi результати:

1. Проведено аналiз сучасних методiв машинного та глибинного навчання, якi використовуються для задач комп’ютерного зору. Встановлено
переваги та недолiки розглянутих пiдходiв, що дозволило сформулювати шляхи для вдосконалення ефективностi дiагностики легеневих
захворювань на основi 2D рентгенограм. Проведений аналiз показав високий потенцiал методiв глибинного навчання для досягнення точностi дiагностики на рiвнi лiкарiв-експертiв, зменшення навантаження на медичний персонал та прискорення обробки великих обсягiв медичних
даних. Виявлено ключовi фактори, що обмежують широке впровадження штучного iнтелекту у клiнiчну практику, зокрема потреба у великих
та збалансованих наборах даних, варiативнiсть апаратiв i протоколiв отримання знiмкiв, а також необхiднiсть забезпечення iнтерпретованостi результатiв для лiкарiв.
