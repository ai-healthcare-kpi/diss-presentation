...
.larger-x[ <p class="shadow" style="line-height: 170%;"> 
...
.larger-xm.success[Основні результати за темою дисертації були висвітлені в .bold[22] наукових працях, які розкривають основний зміст дисертації, зокрема у 16 наукових публікаціях, з яких:
...
.scriptsize[(у тому числі 9 статей у періодичних виданнях, які в базі Scopus мають тип документа «Conference paper» та номер ISSN)]
...
.pub-meta[.pub-doi[[10.1109/STCCSIT.2017.8098808](https://doi.org/10.1109/STC-CSIT.2017.8098808)] .pub-scopus[Scopus]]
]
]
]
]
...
.footnote[Джерело: Abdou, M. A. (2022). Literature review: Efficient deep neural networks techniques for medical image analysis. Neural Computing and Applications, 34(8), 5791-5812.]
...
.success[Метою даної дисертаційної роботи є покращення показників продуктивності методів глибинного машинного навчання для ідентифікації, класифікації та семантичної сегментації об'єктів порівняно з існуючими підходами, зокрема для задачі діагностики легеневих захворювань.]
...
.smaller-x[
1. Проаналізувати переваги та недоліки існуючих методів машинного та глибинного навчання, які застосовуються до задач комп'ютерного зору та сформулювати шляхи вдосконалення результатів ідентифікації, класифікації та семантичної сегментації об'єктів на цифрових зображеннях, зокрема для задачі діагностики легеневих захворювань на основі 2D рентгенограм;]
...
.smaller-x[
1. .inactive-b[Проаналізувати переваги та недоліки існуючих методів машинного та глибинного навчання, які застосовуються до задач комп'ютерного зору та сформулювати шляхи вдосконалення результатів ідентифікації, класифікації та семантичної сегментації об'єктів на цифрових зображеннях, зокрема для задачі діагностики легеневих захворювань на основі 2D рентгенограм;]
1. Розробити технологію попередньої обробки графічних даних на основі глибинних нейронних мереж типу кодер-декодер для сегментації ділянок, що містять цільові об'єкти;]
...
.smaller-x[
1. .inactive-b[Проаналізувати переваги та недоліки існуючих методів машинного та глибинного навчання, які застосовуються до задач комп'ютерного зору та сформулювати шляхи вдосконалення результатів ідентифікації, класифікації та семантичної сегментації об'єктів на цифрових зображеннях, зокрема для задачі діагностики легеневих захворювань на основі 2D рентгенограм;]
1. .inactive-b[Розробити технологію попередньої обробки графічних даних на основі глибинних нейронних мереж типу кодер-декодер для сегментації ділянок, що містять цільові об'єкти;]
...
1. Адаптувати методику зменшення розмірності даних на основі t-SNE для виключення викидів серед розподілу сегментованих масок;]
...
1. .inactive-b[Розробити технологію попередньої обробки графічних даних на основі глибинних нейронних мереж типу кодер-декодер для сегментації ділянок, що містять цільові об'єкти;]
1. .inactive-b[Удосконалити метод глибинного навчання на основі згорткових нейронних мереж шляхом інтеграції сегментації анатомічних структур та вилучення тіней кісток з рентгенограм;]
1. .inactive-b[Адаптувати методику зменшення розмірності даних на основі t-SNE для виключення викидів серед розподілу сегментованих масок;]
...
1. Розвинути метод дистиляції набору даних шляхом узгодження навчальних траєкторій: запропонувати генеративну аугментацію даних для збільшення кількості синтетичних зображень на клас, синтезуючи набір даних, обсяг якого наближається до реального набору даних, що дозволяє моделям, навченим на такому наборі, досягати узагальнювальної здатності, зіставної з моделями, навченими на значно більшому реальному наборі даних.]
...
.smaller-x[
1. .bold[Вперше] запропоновано інтегровану технологію попередньої обробки 2D рентгенограм, яка поєднує сегментацію цільових ділянок на основі глибоких нейронних мереж типу кодер-декодер із подальшою класифікацією патологій. На відміну від класифікації за ознаками всього зображення, запропонована технологія дозволяє зосередити аналіз на клінічно значущих ділянках, знизити вплив нецільових анатомічних структур, зменшити розмірність вхідних даних та покращити результати діагностики окремих легеневих захворювань.
...
.smaller-x[
1. .inactive-b[.bold[Вперше] запропоновано інтегровану технологію попередньої обробки 2D рентгенограм, яка поєднує сегментацію цільових ділянок на основі глибоких нейронних мереж типу кодер-декодер із подальшою класифікацією патологій. На відміну від класифікації за ознаками всього зображення, запропонована технологія дозволяє зосередити аналіз на клінічно значущих ділянках, знизити вплив нецільових анатомічних структур, зменшити розмірність вхідних даних та покращити результати діагностики окремих легеневих захворювань.]

1. .bold[Вперше] запропоновано метод класифікації у федеративному навчанні, що поєднує ансамбль опорних моделей з архітектурами низької обчислювальної складності за стратегією «ширина важливіша за глибину», який на відміну від існуючих підходів до збільшення глибини нейронних мереж, дозволяє підвищити узагальнювальну здатність моделі та зменшити ризик перенавчання за рахунок зменшення дисперсії передбачень при агрегуванні частково некорельованих похибок окремих моделей, при цьому експериментально встановлено, що виграш від ансамблювання залежить від кількості локальних епох навчання між раундами усереднення моделей.
...
<li>  .bold[Удосконалено] метод глибинного навчання на основі згорткових нейронних мереж, який на відміну від відомих методів автоматизованої діагностики за рентгенограмами доповнено етапами сегментації анатомічних структур та вилучення з рентгенограм тіней кісток, що дозволяє зменшити перекриття патологічних ознак кістковими структурами, а також додатково скоротити розмірність вхідних даних за рахунок вилучення нерелевантних ознак, що знижує ризик перенавчання моделі за умов обмеженого розміру навчальної вибірки. </li>
</ol>
...
<li>  .inactive-b[.bold[Удосконалено] метод глибинного навчання на основі згорткових нейронних мереж, який на відміну від відомих методів автоматизованої діагностики за рентгенограмами доповнено етапами сегментації анатомічних структур та вилучення з рентгенограм тіней кісток, що дозволяє зменшити перекриття патологічних ознак кістковими структурами, а також додатково скоротити розмірність вхідних даних за рахунок вилучення нерелевантних ознак, що знижує ризик перенавчання моделі за умов обмеженого розміру навчальної вибірки.] </li>
<li> .bold[Отримав подальший розвиток]  метод виключення викидів серед  сегментованих масок, який, на відміну від відомих підходів, ґрунтується  на проєкції розподілу масок у простір зниженої розмірності за допомогою  методу t-SNE з подальшою пороговою фільтрацією відносно ядра даних, що дозволило покращити якість вхідних даних для методів глибинного  навчання під час класифікації патологічних станів легень за  2D-рентгенограмами. </li>
</ol>
...
<li>  .inactive-b[.bold[Удосконалено] метод глибинного навчання на основі згорткових нейронних мереж, який на відміну від відомих методів автоматизованої діагностики за рентгенограмами доповнено етапами сегментації анатомічних структур та вилучення з рентгенограм тіней кісток, що дозволяє зменшити перекриття патологічних ознак кістковими структурами, а також додатково скоротити розмірність вхідних даних за рахунок вилучення нерелевантних ознак, що знижує ризик перенавчання моделі за умов обмеженого розміру навчальної вибірки.] </li>
<li> .inactive-b[.bold[Отримав подальший розвиток]  метод виключення викидів серед  сегментованих масок, який, на відміну від відомих підходів, ґрунтується  на проєкції розподілу масок у простір зниженої розмірності за допомогою  методу t-SNE з подальшою пороговою фільтрацією відносно ядра даних, що дозволило покращити якість вхідних даних для методів глибинного  навчання під час класифікації патологічних станів легень за  2D-рентгенограмами.] </li>
<li> .bold[Отримав подальший розвиток] метод дистиляції набору даних шляхом узгодження навчальних траєкторій (DDMTT): запропоновано генеративну аугментацію даних GDADD, яка, на відміну від DDMTT, суттєво збільшує кількість синтетичних зображень на клас, синтезуючи набір даних, обсяг якого наближається до реального набору даних. За рахунок цього синтезовані зображення кодують ширший спектр інформативних ознак, що дозволяє моделям, навченим на такому наборі, досягати узагальнювальної здатності, зіставної з моделями, навченими на значно більшому реальному наборі даних.</li>
</ol>
...
.title.larger-x[Процес програмної обробки та аналізу цифрових зображень, спрямований на ідентифікацію, класифікацію та семантичну сегментацію представлених на них об’єктів.]
...
.title.larger-x[Методи попередньої обробки даних, ансамблевої класифікації у федеративному навчанні та генеративної аугментації даних шляхом дистиляції набору даних, що застосовуються при розробленні програмного забезпечення для ідентифікації, класифікації та семантичної сегментації об'єктів на цифрових зображеннях.]
...
.center[<iframe src="aprobation.html" width="800" height="700" style="border:none;"></iframe>]
...
.width-90[![](./figures/pic/tpu-vs-gpu.png)]
...
## Метод сегментації: математична постановка задачі

Нехай $\mathbf{X} \in \mathbb{R}^{H \times W}$ — 2D рентгенограма грудної клітки з датасету, де $H$ та $W$ позначають відповідно висоту та ширину зображення.

Завдання полягає у знаходженні функції відображення

$$f : \mathbf{X} \mapsto \mathbf{S}, \qquad \mathbf{S} \in [0,1]^{H \times W},$$

де $\mathbf{S}$ — сегментована маска, що вказує ймовірність приналежності кожного пікселя до цільової області.

Далі, на основі отриманої сегментованої маски легень виконується класифікація:

$$g : \mathbf{S} \mapsto \mathbf{\hat p}, \qquad \mathbf{\hat p} \in [0,1]^C,$$

де $\mathbf{\hat p}$ — вектор ймовірностей для $C$ визначених класів.
...
.center.width-40[![](./figures/pic/pipline.png)]
...
.center.width-40[![](./figures/pic/pipline_without_bone_shadows.png)]
...
Вхідне зображення $X \in \mathbb{R}^{2048 \times 2048 \times 3}$ перетворюється чотирма згортковими блоками:

$$\boxed{\begin{aligned}
Z^{(l)} &= \text{MaxPool}\_{2\times2} \bigl(\text{ReLU}(W^{(l)} \cdot Z^{(l-1)} + b^{(l)})\bigr), \quad l = 1,2,3 \\\\
Z^{(4)} &= \text{ReLU}(W^{(4)} * Z^{(3)} + b^{(4)}),
\end{aligned}}$$
 
 
де $Z^{(0)} = X$, $\cdot$ — операція двовимірної згортки, $W^{(l)}$ — ядра розміру $3\times3$ з числом фільтрів $c_l \\in \{32,64,128,256\}$.
 
Векторизація: $v = \text{vec}(Z^{(4)}) \in \mathbb{R}^{n}$.
 
Прихований шар: $h = \text{ReLU}(W_1^{\mathsf T} v + b_1) \in \mathbb{R}^{128}$, $W_1 \in \mathbb{R}^{n \times 128}$.
 
Вихідний шар: $\hat{y} = \sigma(w_2^{\mathsf T} h + b_2)$, $\sigma(z) = \dfrac{1}{1+e^{-z}}$, $\hat{y} \in [0,1]$ — імовірність класу «аномальний стан».
 
Функція втрат: $\mathcal{L}(y,\hat{y}) = -\bigl[y\log\hat{y} + (1-y)\log(1-\hat{y})\bigr]$, $y \in \{0,1\}$.
...
.center.width-80[![](./figures/pic/pic-2-11-t-sne.png)]
...
.center.width-100[![](./figures/pic/pic-2-12-t-sne.png)]
...
Для кожної пари точок $x\_i, x\_j \in X$ обчислюються умовні ймовірності подібності $P\_{j|i}$, що відображають ймовірність вибору точки $x\_j$ як сусіда точки $x\_i$ відповідно до гауссового розподілу, центрованого в $x_i$. На основі отриманих умовних ймовірностей формується симетрична матриця подібності $P$, яка описує структуру локальної близькості між усіма масками вихідного набору даних.

.bold[Етап 2. Проєкція у простір зниженої розмірності.]
Координати $Y = \{y\_1, \cdots, y\_N\}$ у просторі розмірності $d$ ($d = 2$ або $3$, обрано для забезпечення можливості візуальної інтерпретації результату) ініціалізуються випадковим чином. Для кожної пари точок у зниженому просторі обчислюється матриця подібності $Q$ на основі розподілу Стьюдента. Остаточне розміщення точок $Y$ визначається шляхом ітераційної мінімізації розбіжності Кульбака--Лейблера між розподілами $P$ та $Q$, що забезпечує узгодженість локальної структури сусідства у вихідному та зниженому просторах. Ітераційний процес продовжується до досягнення збіжності функції втрат.

.bold[Етап 3. Ідентифікація та виключення викидів.]
На отриманій проєкції $Y$ визначається ядро даних -- область найбільшої щільності точок, що відповідає типовим (репрезентативним) маскам набору даних. Для кожної точки $y\_i \in Y$ обчислюється мінімальна відстань до ядра даних; якщо ця відстань перевищує порогове значення $\theta$, відповідна вихідна маска $x\_i$ класифікується як .bold[викид], оскільки її положення у просторі зниженої розмірності свідчить про суттєву відмінність від основного розподілу масок за структурними ознаками. Виключення таких точок дозволяє сформувати очищений набір даних $X^{*} = X \setminus \{\text{викиди}\}$, який надалі використовується для навчання та перевірки моделей глибинного навчання.
]
...
.center.width-100[![](./figures/pic/fl-bb.png)]
...
.center.width-100[![](./figures/pic/fl-agr.png)]
...
<div style="position: relative; width: 90%;">
  <div style="position: relative; width: 100%; height: 70vh;">
    <img src="./figures/pic/fl-bb.png" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; opacity: 0.3;">
    <img src="./figures/pic/fl-agr.png" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain;">
  </div>
...
.bold[Етап 1. Формування експертних траєкторій.]
На початковому етапі здійснюється навчання множини незалежних експертних моделей на повному реальному наборі даних $\mathcal{D}_{\text{real}}$. Для кожної експертної моделі на кожній епосі навчання фіксується знімок параметрів мережі, у результаті чого формується експертна траєкторія: впорядкована послідовність станів параметрів $\{\theta\_0^{\*}, \theta\_1^{\*}, \cdots, \theta\_T^{\*}\}$, що відображає еталонний процес навчання на реальних даних. Оскільки експертні траєкторії обчислюються один раз і надалі можуть багаторазово використовуватися в різних спробах дистиляції без повторного навчання експертних моделей, це забезпечує можливість швидкого й ефективного експериментування з різними конфігураціями методу.

.bold[Етап 2. Дистиляція синтетичного набору даних.]
Синтетичний набір даних $\mathcal{D}\_{\text{syn}}$ ініціалізується (як правило, випадковим чином або на основі випадкової вибірки реальних зображень) і оптимізується ітеративно: на кожній ітерації модель-студент навчається протягом кількох кроків на поточному синтетичному наборі, після чого траєкторія параметрів студента порівнюється з відповідним сегментом експертної траєкторії. Синтетичні зображення коригуються за допомогою градієнтного спуску таким чином, щоб мінімізувати відстань між траєкторією студента та експертною траєкторією, тобто щоб навчання на синтетичних даних якнайточніше відтворювало динаміку навчання на реальних даних.

Вихідними даними методу є: дистильований синтетичний набір даних $\mathcal{D}\_{\text{syn}}$ заданого розміру (кількість зображень на клас, IPC), який за своїми властивостями узагальнення наближається до повного реального набору даних $\mathcal{D}\_{\text{real}}$.
...
<div class="algorithm">
<div class="algo-io">
<span class="algo-label">Вхід:</span> реальний набір даних $\mathcal{D}_{\text{real}}$; кількість експертів $E$; кількість синтетичних зображень на клас IPC (у режимі GDADD: IPC $\gg 10^1$, до значень, що наближають обсяг $\mathcal{D}_{\text{syn}}$ до обсягу $\mathcal{D}_{\text{real}}$); кількість кроків навчання студента $N$; горизонт експертної траєкторії $M$; кількість ітерацій дистиляції
</div>
<div class="algo-steps">
  <div class="algo-step"><span class="algo-num">1</span><span>Навчити $E$ незалежних експертних моделей на наборі $\mathcal{D}_{\text{real}}$ та зберегти для кожної експертну траєкторію $\{\theta_0^*, \theta_1^*, \ldots, \theta_T^*\}$</span></div>
  <div class="algo-step"><span class="algo-num">2</span><span>Ініціалізувати синтетичний набір даних $\mathcal{D}_{\text{syn}}$ розміром $|\mathcal{D}_{\text{syn}}| = \text{IPC} \times C$ (де $C$ -- кількість класів) випадковим шумом або випадковою вибіркою реальних зображень</span></div>
  <div class="algo-block">
    <div class="algo-block-header">До тих пір, поки не досягнута задана кількість ітерацій дистиляції або збіжність функції втрат</div>
    <div class="algo-step"><span class="algo-num">3</span><span>Випадково обрати експертну траєкторію та початкову епоху $t$</span></div>
    <div class="algo-step"><span class="algo-num">4</span><span>Ініціалізувати параметри моделі-студента: $\hat{\theta}_t = \theta_t^*$</span></div>
    <div class="algo-block">
      <div class="algo-block-header">Цикл $i = 1$ до $N$</div>
      <div class="algo-step"><span class="algo-num">5</span><span>Виконати один крок навчання моделі-студента на $\mathcal{D}_{\text{syn}}$ із застосуванням диференційовних аугментацій</span></div>
    </div>
    <div class="algo-step"><span class="algo-num">6</span><span>Отримати параметри моделі $\hat{\theta}_{t+N}$</span></div>
    <div class="algo-step"><span class="algo-num">7</span><span>Обчислити функцію втрат $\mathcal{L}(\mathcal{D}_{\text{syn}})$ як нормалізовану відстань між $\hat{\theta}_{t+N}$ та $\theta_{t+M}^*$ </span></div>
    <div class="algo-step"><span class="algo-num">8</span><span>Оновити синтетичний набір даних $\mathcal{D}_{\text{syn}}$ градієнтним спуском </span></div>
  </div>
</div>
<div class="algo-io">
<span class="algo-label">Вихід:</span> дистильований синтетичний набір даних $\mathcal{D}_{\text{syn}}$ <span class="algo-comment">(в режимі GDADD: $|\mathcal{D}_{\text{syn}}| \to |\mathcal{D}_{\text{real}}|$)</span>
</div>
</div>
]
...
.grid[
.kol-1-3[ 
.center.width-100[![](./figures/pic/pic2-7-jsrt-a.png)]
.bold.center[а) Оригiнальний приклад, датасет №01, JSRT]

]

.kol-1-3[ 
.center.width-100[![](./figures/pic/pic2-7-jsrt-b.png)]
.bold.center[б) Передбачена маска легень]

  ]

.kol-1-3[
.center.width-90[![](./figures/pic/pic2-7-jsrt-c.png)]
...
.grid[
.kol-1-3[ 
.center.width-100[![](./figures/pic/pic2-8-bse-jsrt-a.png)]
.bold.center[а) Оригiнальний приклад, датасет №02, BSE-JSRT]

]

.kol-1-3[ 
.center.width-100[![](./figures/pic/pic2-8-bse-jsrt-b.png)]
.bold.center[б) Передбачена маска легень]

  ]

.kol-1-3[
.center.width-90[![](./figures/pic/pic2-8-bse-jsrt-c.png)]
...
.grid[
.kol-1-3[ 
.center.width-115[![](./figures/pic/pic-2-10-a.png)]
.bold.center[а) Найбiльш несхожа маска]

]

.kol-1-3[ 
.center.width-115[![](./figures/pic/pic-2-10-b.png)]
.bold.center[б) Подібна маска]

  ]

.kol-1-3[
.center.width-100[![](./figures/pic/pic-2-10-c.png)]
...
.grid[
.kol-1-3[ 
.center.width-100[![](./figures/pic/seg-jsrt.png)]
.bold.center[а) Сегментована маска легень з датасету JSRT]

]

.kol-1-3[ 
.center.width-100[![](./figures/pic/seg-bon-mask.png)]
.bold.center[б) Маска кiсток]

  ]

.kol-1-3[
.center.width-90[![](./figures/pic/seg-without-bones.png)]
...
.width-95[![](./figures/pic/jsrt-train-4.png)]
...
.width-100[![](./figures/pic/jsrt-train.png)]
...
.grid[
.kol-1-3[ 
.center.width-100[![](./figures/pic/sh-a.png)]
.bold.center[а)]

]

.kol-1-3[ 
.center.width-100[![](./figures/pic/sh-b.png)]
.bold.center[б)]

  ]

.kol-1-3[
.center.width-90[![](./figures/pic/sh-c.png)]
.bold.center[в) ]
...
.width-100[![](./figures/pic/sh-gender.png)]
...
.width-85[![](./figures/pic/sh-seg-train.png)]
.width-85[![](./figures/pic/sh-seg-train-loss.png)]
...
.width-100[![](./figures/pic/sh-mean.png)]
...
.width-90[![](./figures/pic/CheXpert.png)]
...
.width-90[![](./figures/pic/cheXpert-tab.png)]
...
.width-80[![](./figures/pic/as-roc.png)]
...
.width-100[![](./figures/pic/output_64_2-small.png)]
...
.width-100[![](./figures/pic/fd-param.png)]
...
.width-100[![](./figures/pic/fl-batch.png)]
...
.width-90[![](./figures/pic/fl-lcnet-version.png)]
...
.width-100[![](./figures/pic/fl-nbn.png)]
...
.width-100[![](./figures/pic/fl-local.png)]
.center.caption-fig[Типовi кривi валiдацiйних втрат а) та валiдацiйної точностi б) для архiтектури LCNet050 з рiзною кiлькiстю опорних моделей
...
.width-100[![](./figures/pic/fl-max.png)]

---

class: middle 

.width-100[![](./figures/pic/cifar-syn.png)]
...
.width-100[![](./figures/pic/path-syn.png)]
...
.width-100[![](./figures/pic/cifar-ipc.png)]
...
.width-100[![](./figures/pic/cifar-100-ipc.png)]
...
.width-100[![](./figures/pic/path-ipc.png)]
...
.width-100[![](./figures/pic/derma-ipc.png)]
...
.width-100[![](./figures/pic/retana-ipc.png)]
...
.center.caption-fig[Максимальні значення точності на валідаційній вибірці для датасету зі слабким дисбалансом класів (PathMNIST) та датасетів із вираженим дисбалансом класів (DermaMNIST, RetinaMNIST)]
.width-100[![](./figures/pic/medmnist-acc2.png)]

---

class: middle, center

.width-80[![](./figures/pic/ipc-all.png)]
...
.width-100[![](./figures/pic/serviceplatf.png)]
...
.width-100[![](./figures/pic/p20platf.png)]
...
.smaller-x[У дисертаційному дослідженні розв'язане актуальне наукове завдання, яке спрямоване на покращення результатів аналізу медичних даних, зокрема діагностики легеневих захворювань, шляхом створення та оптимізації методів і моделей глибинного машинного навчання для ідентифікації, класифікації та семантичної сегментації об'єктів, зокрема алгоритмів семантичної сегментації анатомічних структур і вилучення тіней кісток з рентгенограм, ансамблевої класифікації у федеративному навчанні, а також методів виключення викидів серед розподілу сегментованих масок та генеративної аугментації даних методом дистиляції набору даних (GDADD). У результаті було отримано такі наукові і практичні результати:]
...
<li> Вперше запропоновано інтегровану технологію попередньої обробки 2D рентгенограм, яка поєднує сегментацію цільових ділянок на основі глибоких нейронних мереж типу кодер-декодер із подальшою класифікацією патологій. На відміну від класифікації за ознаками всього зображення, запропонована технологія дозволяє зосередити аналіз на клінічно значущих ділянках і покращити результати діагностики окремих легеневих захворювань за рахунок зменшення впливу нецільових анатомічних структур на результат класифікації та зменшення розмірності вхідних даних у 3,2 ± 0,7 рази (середня частка площі сегментації &mdash; 0,32 ± 0,06). Експериментально встановлено, що вплив сегментації на результати класифікації є нерівномірним залежно від типу патології та розміру вибірки: для малих та незбалансованих наборів даних (JSRT, BSE-JSRT) сегментація суттєво покращує здатність моделі до навчання, тоді як для великого набору даних (CheXpert) її вплив на якість діагностики є обмеженим, оскільки модель здатна самостійно виокремити релевантні ознаки з достатньо великої вибірки; покращення діагностичної точності на CheXpert спостерігалося лише для окремих класів патологій (Lung Opacity, Consolidation та Pleural Other).<br>
Застосування сегментації у поєднанні з аугментацією даних  забезпечило покращення діагностичної точності для 10 із 14 досліджуваних патологій порівняно з моделлю, навченою лише на сегментованих зображеннях (без аугментації). Зменшення кількості нерелевантних ознак завдяки сегментації є особливо корисним для невеликих вибірок, де обмежена кількість прикладів підвищує ризик того, що модель почне враховувати випадкові патерни у фонових областях зображення (поза межами легень) замість клінічно значущих ознак. Для великих вибірок цей ризик зменшується, оскільки достатня кількість прикладів дозволяє моделі самостійно навчитися ігнорувати нерелевантні області зображення без попередньої сегментації. </li>
...
???
 Для великих вибірок цей ризик зменшується, оскільки достатня кількість прикладів дозволяє моделі самостійно навчитися ігнорувати нерелевантні області зображення без попередньої сегментації.
...
<li> Отримав подальший розвиток метод виключення викидів серед  сегментованих масок, який, на відміну від відомих підходів, ґрунтується  на проєкції розподілу масок у простір зниженої розмірності за допомогою  методу t-SNE з подальшою пороговою фільтрацією відносно ядра даних, що дозволило покращити якість вхідних даних для методів глибинного  навчання під час класифікації патологічних станів легень за  2D-рентгенограмами.</li>
</ol>
...
<li> Розроблені методи з використанням сегментації, вилучення тіней кісток, виключення викидів, генеративної аугментації даних та ансамблювання опорних моделей у рамках федеративного навчання є взаємодоповнювальними за характером дії: перші чотири методи спрямовані на послідовне зменшення різних типів надлишковості та шуму  на рівні вхідних даних (просторової &mdash; сегментація, структурної &mdash; вилученням тіней кісток, статистичної &mdash; виключення викидів) та компенсацію дефіциту репрезентативності класів (аугментація даних), тоді як ансамблювання опорних моделей забезпечує підвищення надійності рішення на рівні агрегації прогнозів. Ефективність кожного компонента підтверджено експериментально за окремою лінією дослідження; частину методів інтегровано на рівні програмної платформи, що обґрунтовує перспективність подальшого застосування розроблених методів для підвищення узагальнювальної здатності та надійності систем автоматизованого аналізу візуальних даних до рівня продуктивності, зіставного з лікарями-експертами; кількісна оцінка сукупного ефекту в єдиному наскрізному експерименті становить завдання подальших досліджень.</li>
